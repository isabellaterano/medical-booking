      ...
      <div>
        <div className="hero min-h-screen bg-base-200">
          <div className="hero-content flex-col lg:flex-row">
            <img src={Food} className="max-w-sm rounded-lg shadow-2xl" />
            <div className="mx-12">
              ...
              <p className="py-6">
                The finding comes from a study published this month in the
                journal Nature Mental Health and warns about the possible risks
